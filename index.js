...
function removeFromCart(index) {
    ...
    localStorage.setItem('cart', JSON.stringify(cart));
    updateCartCount();
    showNotification(`${removed.title} removed from cart!`, 'error');
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    renderFeaturedSection('bestsellersGrid', books.slice(4, 8));
    renderFeaturedSection('editorsChoiceGrid', books.slice(8, 12));
